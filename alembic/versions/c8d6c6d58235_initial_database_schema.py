...
Revision ID: c8d6c6d58235
Revises: 
Create Date: 2025-10-17 12:33:57.700441
...
def upgrade() -> None:
    ...
    sa.Column('has_used_live_queue', sa.Boolean(), server_default=sa.text('false'), nullable=False),
