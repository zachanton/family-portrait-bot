...
async def wait_postgres(
    *,
    ...
    # asyncpg does not understand the 'postgresql+asyncpg' dialect, which is needed for SQLAlchemy.
    # We remove '+asyncpg' to get a clean DSN that asyncpg can understand.
    dsn_for_asyncpg = dsn.replace("+asyncpg", "")
