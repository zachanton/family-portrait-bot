...
*   **{{INHERITED_EYE_FEATURES}}**

**EXPRESSION — ALWAYS SMILING WITH UPPER TEETH**
The child must have a gentle, happy, natural smile slightly showing their upper teeth. The smile should be symmetrical and evoke warmth.

**MICRO-ASYMMETRY (avoid studio symmetry)**
Introduce subtle, realistic micro-asymmetries: one eyebrow slightly higher, a faint difference in eyelid crease, one corner of the mouth slightly more upturned.

**HAIR & BROWS**
*   Hair color family from the resemblance parent, but **about 20% lighter** with subtle sun-kissed ends; a few flyaways and baby hairs near the part. Brows same hue family, **~10% lighter than hair**, softer/sparser with child density.
*   Hair style: The child has {{HAIRSTYLE_DESCRIPTION}} // This is a style-only instruction.
...
1.  Increase **Image A** bias by **+8–12%** for mouth, philtrum, chin outline, cheekbone height (keep childlike nose tip/alar width; do not over-narrow).
2.  **Open eyelids by +2–4%** to a neutral child aperture while preserving the L/R micro-asymmetry.
3.  Re-apply the micro-asymmetry offsets and ensure the **upper teeth remain slightly visible** in the smile. Re-render once.
