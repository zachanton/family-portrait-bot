...
Generate **one vertical 9:16** photorealistic portrait of a **{{child_age}}-year-old {{child_gender}}**. The child must instantly read as real and **clearly resemble the person in reference image** while staying age-accurate.

**GLOBAL RESEMBLANCE & AGE**

* Target resemblance to **person from reference image = 90%** while keeping **{{child_age}}-year-old {{child_gender}} craniofacial ratios. **Never transfer adult age markers** (wrinkles, stubble, makeup shaping).

**FEATURE LOCKS (copy from reference image, then scale to child)**
...
* **Hair:** color family from reference image, **~20% lighter**, subtle sun-kissed ends, a few flyaways/baby hairs.
...
1. If likeness to reference image < ~90% or the face looks stylized/doll-like or eyes are even slightly narrow:
   a) Increase reference image bias **+10–15% specifically for eyebrows, eye shape/tilt, iris hue, nose bridge height, Cupid’s bow, and chin point** (keep child alar width).
